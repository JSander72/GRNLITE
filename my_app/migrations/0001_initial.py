    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "genres",
                    models.ManyToManyField(
                        related_name="custom_users", to="my_app.genre"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "genres",
                    models.ManyToManyField(
                        related_name="beta_readers", to="my_app.genre"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("user_type", models.CharField(default="default_type", max_length=50)),
                ("name", models.CharField(default="Default Name", max_length=255)),
                ("genre", models.CharField(default="Unknown", max_length=255)),
                (
                    "role",
                    models.CharField(
